...
from mdformat._util import build_mdit, is_md_equal
from mdformat.renderer.tree import TreeRenderer
...
def test_commonmark_spec_tree(entry):
    ...
    md_new = mdit.render(md_original)
    md_2nd_pass = mdit.render(md_new)
