...
def is_md_equal(
    ...
    *,
    ...
    Renders HTML from both Markdown strings, reduces whitespace
    sequences to single space chars, and checks equality. Note that this
    is not a perfect solution, as there can be meaningful whitespace in
